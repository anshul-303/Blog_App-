...
export default function AuthorPublishedCard() {
  return (
    <div className="bg-zinc-800 md:w-[47vw] md:h-[26vh] h-[18vh] w-[93vw] mr-4 md:m-0 flex flex-col justify-start items-start p-6 border border-zinc-700 rounded-lg border-[2px] gap-2">
      <p
